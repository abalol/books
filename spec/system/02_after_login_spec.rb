...
describe '[STEP2] ユーザログイン後のテスト' do
  ...
  describe '投稿一覧画面のテスト' do
    ...
    context '表示内容の確認' do
      ...
      it '自分の投稿と他人の投稿のタイトルのリンク先がそれぞれ正しい' do
        expect(page).to have_link book.title, href: show_book_path(book)
        expect(page).to have_link other_book.title, href: show_book_path(other_book)
      end
  ...
  describe '自分の投稿詳細画面のテスト' do
    ...
    context '表示内容の確認' do
      ...
      it '投稿の削除リンクが表示される' do
        expect(page).to have_link 'Destroy', href: destroy_book_path(book)
      end
    end
  ...
  describe '自分の投稿編集画面のテスト' do
    ...
    context '表示の確認' do
      ...
      it 'Showリンクが表示される' do
        expect(page).to have_link 'Show', href: show_book_path(book)
      end
      it 'Backリンクが表示される' do
